...
public class Queen extends Piece{
	/**
	 * A constructor for the Queen class. Calls a super constructor inside.
	 * 
	 * @param pieceColor
	...
	/**
	 * A method to determine if the move being made with the Queen is legal or not
	 * 
	 * @param currColor
